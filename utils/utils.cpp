...
auto utils::waitonmodules(std::int32_t timeout, const std::initializer_list<std::wstring>& modules) -> int
{
	bool signaled[32] = { 0 };
	bool success = false;
...
auto utils::patternscan(const char* dll, const char* signature) -> std::uint8_t*
{
