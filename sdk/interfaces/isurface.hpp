...
namespace sdk
{
	...
	public:
		...
		virtual void          DrawPrintText(const wchar_t* Text, int Len, int DrawType) = 0;
		...
		inline void           DrawFilledRectangleFade(int x0, int y0, int x1, int y1, size_t alpha0, size_t alpha1, bool horizontal)
		{
			using fn = void(__thiscall *)(void *, int, int, int, int, size_t, size_t, bool);
			vfunc<fn>(this, 123)(this, x0, y0, x1, y1, alpha0, alpha1, horizontal);
		}
	};
}